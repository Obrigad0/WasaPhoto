...
function createDevtoolsComponentHook(hook) {
  return (component) => {
    emit2(hook, component.appContext.app, component.uid, component.parent ? component.parent.uid : void 0, component);
  };
}
...
function createDevtoolsPerformanceHook(hook) {
  return (component, type, time) => {
    emit2(hook, component.appContext.app, component.uid, component, type, time);
  };
}
function devtoolsComponentEmit(component, event, params) {
  emit2("component:emit", component.appContext.app, component, event, params);
}
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(render3.length > 1 ? render3(props, true ? {
        ...
        slots,
        emit: emit3
      } : { attrs, slots, emit: emit3 }) : render3(
        props,
        null
...
function genNode(node, context) {
  ...
  switch (node.type) {
    ...
    case 9:
    case 11:
      assert2(node.codegenNode != null, `Codegen node is missing for element/if/for node. Apply appropriate transforms first.`);
...
*/
//# sourceMappingURL=chunk-KDKFXLR4.js.map
